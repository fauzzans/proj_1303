...
<body>
  ...
  <div class="container">
    ...
    <h1 class="mt-4 mb-3">Pendiri Pesantren
    </h1>
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Pendiri Pesantren</li>
    </ol>

    <!-- Intro Content -->
    <div class="row">
      <div class="col-md-6">
        <img class="img-fluid rounded mb-4" src="img/founder.jpg" alt="">
      </div>
      <div class="col-md-6" style="text-align: justify;">
        <h4 class="my-3" style="text-align: center;">PP. DARUT TAFSIR <br>(Tempat Belajar Pimpinan Majelis)<br>
          (SYAIKHUL MASYAYIKH PP. DARUT TAFSIR)</h4>
        <p>
        <h5>1. Kelahiran, Silsilah dan Latar Belakang Keluarga</h5>
    ...
    <div class="my-4">
      ...
      <ol>
        ...
        <ul>
          <li>Pengembangan mental para pejuang dan masyarakat</li>
          <li>Mengatur taktik dan strategi bertempur</li>
          <li>Rapat-rapat</li>
          <li>Lain-lain</li>
        </ul>
        <li>Setelah Merdeka</li>
        <p>Pada masa pasca kemerdekaan ini, Al-Maghffurlah aktif membina masyarakat, baik melalui pengajian-pengajian maupun melalui organisasi, yaitu masyumi dan kemudian bergabung dengan Nahdltul Ulama.
          <br>
      ...
      <ol type="A">
        ...
        <ol>
          <li>Keutamaan manusia terletak dari seberapa ia memahami ajaran Allah dan Rosul-Nya dalam rangka mengamalkan ajaran agama secara utuh.</li>
          <li>Luasnya Ilmu Allah, menuntut manusia untuk senantiasa belajar dan berusaha mengemalkanya sepanjang hidup</li>
          <li>Pengabdian dalam menegakkan ajaran Islam harus selalu dilaksanakan pada setiap kesempatan, pada situasi dan kondisi yang bagaimanapun sepanjang hidup dan dilakukan dengan bijaksana (bilhikmah)</li>
          <li>Untuk terbentuknya ummat yang berkualitas dan menjadi contoh umat lain, haruslah melalui pembinaan dan pendidikan yang bermutu pula.</li>
          <li>Persatua dan Kesatuan ummat lebih penting diatas kepentingan golongan baik politik maupun agama.</li>
          <li>Untuk melahirkan ummat yang berkualitas diperlukan pendidikan yang mampu memadukan secara harmonis antara akhlaq, ilmu agama dengan ilmu-ilmu pengetahuan lainya.</li>
        </ol>
        <li>Karya Tulis</li>
        <ol>
          <li>Kitab / Buku</li>
          <ol type="a">
            <li>Pelengkap Ilmu Tafsir</li>
            <li>Ulumul Qur’an</li>
          </ol>
          <li>Karya Ilmiah / Makalah</li>
          <ol type="a">
            <li>Peran akal dalam menafsirkan Alqur’an</li>
            <li>Metode Pengkajian Alqur’an</li>
            <li>Hikmah Puasa</li>
            <li>Keutamaan pribadi para sahabat</li>
            <li>Riwayat Hidup Imam Syafi’i</li>
            <li>Jalan pikiran Imam Al-Ghozali</li>
          </ol>
        </ol>
        </p>
      </ol>
