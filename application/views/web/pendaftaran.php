...
<head>
  ...
  <title>PPDB Pondok Pesantren Darut Tafsir</title>
      ...
      <div>
        ...
        <div class="page-content page-wizard">
          ...
          <div class="header" style="margin-top:-20px;">
            <h2>Form Pendaftaran PPDB Online <strong> Pondok Pesantren Darut Tafsir</strong></h2>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 panel p-20" style="text-align:center">
                                ...
                                <span style="font-size:15px">
                                  Proses PPDB Online Pondok Pesantren Darut Tafsir hampir selesai. Silakan periksa kembali data-data calon siswa yang sudah anda masukkan.
                                  <br><br>
                                  <div class="col-md-12">
            ...
            <div class="footer">
              <div class="copyright">
                <p class="pull-left sm-pull-reset">
                  <span>Copyright &copy; <a href="http://www.sman1belitang.sch.id" target="_blank">Pondok Pesantren Darut Tafsir</a> <?php echo date('Y'); ?> | IT Development</span>
                </p>
