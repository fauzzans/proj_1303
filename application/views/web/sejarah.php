...
<body>
  ...
  <div class="container">
    ...
    <div class="my-4">
      ...
      <h5>BERDIRINYA PESANTREN DARUT TAFSIR</h5>
      <p>
      ...
      <ol type="a">
        <li>Belum adanya kurikulum Pesantren. Sedangkan Kurikulum Fakultas jurusan Ilmu Tafsir tidak dapat
          diterapkan dalam pesantren.</li>
        <li>Belum adanya buku-buku Tafsir yang sistematik</li>
      </ol>
      Maka untuk memenuhi kebutuhan-kebutuhan tersebut, telah ditulis dua buah buku :
      <ol type="1">
        <li>PELENGKAP TAFSIR</li>
        <li>AHKAMUL QUR’AN</li>
      </ol>
      </p>
      <h5>KEPINDAHAN PESANTREN "DARUT TAFSIR"</h5>
      <p>
