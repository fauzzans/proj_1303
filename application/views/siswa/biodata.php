    ...
    <div class="row">
      ...
      <div class="panel panel-flat">
          <div class="panel-body">
              <center>
                <img src="img/ava.jpg" alt="<?php echo $user->nama_lengkap; ?>" class="" width="176">
              </center>
            <br>
...
<!--                    </tr>-->
                    ...
                    <tr>
                      <th>Jenis Kelamin</th>
                      <th>:</th>
                      <td><?php if ($user->jenis_kelamin == '1') {echo "Laki - laki";}else if($user->jenis_kelamin == '2'){echo "Perempuan";}else{echo " ";}  ?></td>
                    </tr>
                    <tr>
                      <th>Tempat, Tgl Lahir</th>
                      <th>:</th>
                      <td><?php echo $user->tempat_lahir.", ". date('d-m-Y', strtotime($user->tgl_lahir)); ?></td>
                    </tr>
                    <tr>
                      <th>Anak Ke</th>
                      <th>:</th>
...
<!--                    </tr>-->
                    ...
                    <tr>
                        ...
                        <th>:</th>
                        <td><?php if ($user->ket_siswa == '1'){echo "Anak Yatim";}else if ($user->ket_siswa == '2'){echo "Piatu";}else if ($user->ket_siswa == '3'){echo "Yatim Piatu";}else if ($user->ket_siswa == '4'){echo "Lengkap";} $user->no_telp; ?></td>
                    </tr>
                </table>
              </div>
            </fieldset>
...
<!--                      <th>Pendidikan</th>-->
<!--                      <th>:</th>-->
<!--                      <td>--><?php //echo $ortu->ayah_pendidikan; ?><!--</td>-->
<!--                    </tr>-->
<!--                    <tr>-->
<!--                      <th>Pekerjaan</th>-->
<!--                      <th>:</th>-->
<!--                      <td>--><?php //echo $ortu->ayah_pekerjaan; ?><!--</td>-->
<!--                    </tr>-->
<!--                    <tr>-->
<!--                      <th>Penghasilan</th>-->
<!--                      <th>:</th>-->
